// Script to add test words for review with proper dates
...
async function addReviewTestWords() {
  try {
    ...
    console.log('🔍 Adding test words for review with proper dates...');
    ...
    // Set next_review_date to today or yesterday so they're due for review
